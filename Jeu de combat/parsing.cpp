		...
		while (getline(c, line))
		{
			...
			while (getline(iss, word, '\t')) //Tant que la ligne n'est pas parcourue de \t en \t jusqu'à la fin, on lit les mots.
			{
				...
				if (word == "Classe")
				{
					...
					if (word == "Mage")
					{
						creation_Character->m_classe_Character = (type_Character)1;
					}
					if (word == "Guerrier")
					{
						creation_Character->m_classe_Character = (type_Character)3;
					}
					if (word == "Archer")
					{
						creation_Character->m_classe_Character = (type_Character)1;
					...
					if (word == "Voleur")
					{
						creation_Character->m_classe_Character = (type_Character)2;
					}
				}
		...
		while (getline(w, line2))
		{
			...
			while (getline(iss, word2, '\t')) //Tant que la ligne n'est pas parcourue de \t en \t jusqu'à la fin, on lit les mots.
			{
				...
				if (word2 == "Type")
				{
					...
					if (word2 == "Baton")
					{
						creation_Weapon->m_classe_Weapon = "Baton"; //(type_Weapon)3
					}
					if (word2 == "Epee")
					{
						creation_Weapon->m_classe_Weapon = "Epee"; //(type_Weapon)2
					}
					if (word2 == "Arc")
					{
						creation_Weapon->m_classe_Weapon = "Arc"; //(type_Weapon)0
					}
					if (word2 == "Dague")
					{
						creation_Weapon->m_classe_Weapon = "Dague"; //(type_Weapon)1
					}
				}
